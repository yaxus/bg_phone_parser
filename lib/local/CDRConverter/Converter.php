...
class CDRConverter_Converter
{
	...
	protected function treat_source($src_cfg)
	{
		...
		foreach ($files as $f)
		{
			...
			$cdr->init_new_file($f);
			Log::instance()->info("File: {$f} in progress...");
			// $check_repeat = array();
	...
	{
		$i = array('datet', 'duration', 'A164', 'B164');
